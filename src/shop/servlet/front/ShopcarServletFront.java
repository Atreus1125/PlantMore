...
import shop.util.ShopcarCookieUtil;
...
public class ShopcarServletFront extends HttpServlet {
    ...
    public String insert(HttpServletRequest request, HttpServletResponse response) {
        ...
        System.out.println("******ShopcarServletFront.insert收到的用户名为" + mid + "******");
        ...
        String url = "pages/front/goods/GoodsServletFront" + referer.substring(referer.lastIndexOf("/"));//从哪来回哪去
        System.out.println("******ShopcarServletFront.insert的跳转路径为" + url + "******");
    ...
    public String update(HttpServletRequest request, HttpServletResponse response) {
        ...
        while (enu.hasMoreElements()) {
            ...
            System.out.println("******enu.nextElement()为" + temp + "******");
