...
<%
    ...
    System.out.println("******member_update.jsp页面的basePath为" + basePath + "******");
%>
<!doctype html>
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-2">
                        ...
                        <ul class="nav flex-column dashboard-list" role="tablist">
                            ...
                            <li><a class="nav-link" data-toggle="tab" href="#account-details">账户详情</a></li>
                            <li><a class="nav-link" href="pages/MemberServletFront/logout">退出登录</a></li>
                        </ul>
                    </div>
                                        ...
                                        <form action="<%=updateUrl%>" method="post" enctype="multipart/form-data">
                                            <div class="login-form-container">
                                                <div class="account-login-form">
                                                    <label>用户ID</label><h4>${member.mid}</h4><br>
                                                    <label>真实姓名</label>
                                                    ...
                                                    <label>用户头像</label>
                                                    <td><input type="hidden" name="oldpic" id="oldpic" value="${member.photo}"></td>
                                                    <td><input type="file" onchange="preview(this)" name="photo" id="photo"></td>
                                                    <span class="custom-checkbox">
                                                        <input name="option" value="1" type="checkbox">
                                                        <label>我已阅读并同意平台用户协议</label>
                                                    </span>
                                                    <span class="custom-checkbox">
                                                        <input name="newsletter" value="1" type="checkbox">
                                                        <label>订阅我们的邮件及短信通知<br><em>您可以随时取消订阅</em></label>
                                                    </span>
                                                    <div class="button-box">
                                                        <button type="submit" class="default-btn">保存</button>
                                                        <button type="reset" class="default-btn">重置</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
